...
;(function(window) {
	...
	Turntable.prototype._getSongName = function(url) {
		return url.substring(12, url.indexOf('.mp3'));
	};
	...
	function loadTurntableAssets(callback) {
		new AbbeyLoad([{ 
			'room1' : '/static/js/music/room1.mp3',
			'room2' : '/static/js/music/room2.mp3',
			'room3' : '/static/js/music/room3.mp3',
			'noise' : '/static/js/music/noise1.mp3'
		}], function(bufferList) {
			if( typeof callback === 'function' ) {
				callback(bufferList);
			}
